...
docker-compose exec mysql mysql -uroot -proot -e "DROP DATABASE IF EXISTS \`test\`";
docker-compose exec mysql mysql -uroot -proot -e "CREATE DATABASE IF NOT EXISTS \`test\` COLLATE 'utf8_general_ci';";
